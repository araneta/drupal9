...
class __TwigTemplate_6a792573bb6647852e655919f83e2550b553a9225ba61fb60b8b47ac5663ee7c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "/var/www/drupal9/voxteneo/web/themes/bootstrap/templates/input/input--button.html.twig");
    }
